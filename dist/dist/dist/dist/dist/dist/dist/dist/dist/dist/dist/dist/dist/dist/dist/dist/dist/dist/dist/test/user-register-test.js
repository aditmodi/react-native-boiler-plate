...
describe('Users', function () {
  ...
  describe('register', function () {
    ...
    it('should not register an existing user', function () {
      _chai2.default.request('http://192.168.1.189:3001/api').post('/register').send(_user4.default.register.existingUser).end(function (err, res) {
    ...
    it('should not register user with invalid credentials', function () {
      _chai2.default.request('http://192.168.1.189:3001/api').post('register').send(_user4.default.register.invalidUser).end(function (err, res) {
        res.should.have.status(400);
        res.body.errors.should.have.property('message').eql('Invalid credentials');
      });
    });

    it('should not register a null user', function () {
      _chai2.default.request('http://192.168.1.189:3001/api').post('register').send(_user4.default.register.nullUser).end(function (err, res) {
        res.should.have.status(400);
